...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="pt-5">
                <h2 class="text-center font-weight-light">Link Penting</h2>
            </div>
            <div class="row">
                <div class="card col-12">
                    <div class="card-header">
                        ...
                        <button class="btn btn-primary" id="btn-plus">
                           <a href="https://docs.google.com/spreadsheets/d/1kFh1TdTbeksY7yigSnFaVcZbKSrMFh5R9vHvGnymBrY/edit?gid=0#gid=0" target="_blank">
...
<script> 
 ...
 let gsheet = new GAS({
    ...
    id: "1kFh1TdTbeksY7yigSnFaVcZbKSrMFh5R9vHvGnymBrY",
    dataShow: 3,
    label:["Keterangan","Link"],
