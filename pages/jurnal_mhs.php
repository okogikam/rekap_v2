...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="pt-5">
                <h2 class="text-center font-weight-light">Jurnal Mahasiswa</h2>
            </div>
            <div class="row">
...
<script> 
 ...
 let gsheet = new GAS({
    ...
    id: "1im_Q8qnViqHD--c91ABRAZnnr_Q107bw46ZEpxsbtIY",
    dataShow: 8,
label:['NIM','Nama','Pemb 1','Pemb 2','Hasil Plagiasi','Publikasi','Ket'],
